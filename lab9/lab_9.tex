...
\newpage
\par 
На рисунке 3 представлены частотные характеристики консервативного .
    ...
    \begin{subfigure}{0.5\textwidth}
        ...
        \begin{tikzpicture}
            \begin{semilogxaxis} [
                    ...
                    xlabel = {$\omega$, 1/c},
                    ylabel = {$L_m$, дБ},
                    ytick = { 14.07, 22.64, -10, -20, -25.93 },
                    extra x ticks = {0.2},
                    xtick = {10e-3, 10e-1, 10e+0, 10e+1}
                ]
                \addplot table [x={w}, y={L}] {data/data3.1.txt};
                \addplot table [x={w}, y={L}] {data/data3.2.txt};
                \draw (1, 13.94) -- (10, 13.94) -- (100, -25.93);
            \end{semilogxaxis}
        \end{tikzpicture}
        \caption{График ЛАЧХ и асимптотическая ЛАЧХ}
    \end{subfigure}
    \begin{subfigure}{0.5\textwidth}
        ...
        \begin{tikzpicture}
            \begin{semilogxaxis} [
                    ...
                    xlabel = {$\omega$, 1/c},
                    ylabel = {$\psi$, градусы},
                    ytick = { 0, 120, 140, 160, -180 }
                ]
                \addplot table [x={w}, y={psi}] {data/data3.1.txt};
                 \addplot table [x={w}, y={psi}] {data/data3.2.txt};
            \end{semilogxaxis}
        \end{tikzpicture}
        \caption{График ЛФЧХ}
    \end{subfigure}
    ...
    \begin{subfigure}{0.5\textwidth}
        ...
        \begin{tikzpicture}
            \begin{polaraxis} [
                ...
                \addplot table [x={psi}, y={A}] {data/data3.1.txt};
                \addplot table [x={psi}, y={A}] {data/data3.2.txt};
            \end{polaraxis}
        \end{tikzpicture}
        \caption{График АФЧХ}
    \end{subfigure}
    \begin{subfigure}{0.5\textwidth}
        ...
        \begin{tikzpicture}
            \begin{polaraxis} [
                ...
                \addplot table [x={psi}, y={L}] {data/data3.1.txt};
                 \addplot table [x={psi}, y={L}] {data/data3.2.txt};
            \end{polaraxis}
        \end{tikzpicture}
        \caption{График ЛАФЧХ}
    \end{subfigure}
