...
\begin{figure}[h!]
    ...
    \begin{subfigure}{0.5\textwidth}
        ...
        \end{tikzpicture}
    \end{subfigure}
    \caption{Графики прехеходных процессов при  $M_\text{СМ}$ = 0}
\end{figure}
...
\begin{figure}[h!]
	\begin{subfigure}{0.5\textwidth}
		...
		grid style = {dashed},
		xmin = 0, xmax = 0.6,
		extra y ticks={0, 10, 7.72, 5},
		extra y tick style={grid style={black, thick, dashed}},
		ytick = {0, 2},
		]
	
		\addplot[blue, mark = none, thick, smooth, solid] table [x = t, y = w2] {data/FullModel/Moment-w.dat};
	...
	\begin{subfigure}{0.5\textwidth}
		...
		grid style = {dashed},
		xmin = 0, xmax = 0.6,
		extra y ticks={0, 2.78, 5,  10},
		extra y tick style={grid style={black, thick, dashed}},
		ytick = {4},
		]
	
		\addplot[blue, mark = none, thick, smooth, solid] table [x = t, y = I2] {data/FullModel/Moment-I.dat};
	...
	\begin{subfigure}{0.5\textwidth}
		...
		\addplot[blue, mark = none, thick, smooth, solid] table [x = t, y = alpha2] {data/FullModel/Moment-alpha.dat};
	...
	\begin{subfigure}{0.5\textwidth}
		...
		\end{tikzpicture}
	\end{subfigure}
	\caption{Графики прехеходных процессов при различных $M_\text{СМ}$ = 3[Нм]}
\end{figure}
\newpage
\begin{figure}[h!]
	\begin{subfigure}{0.5\textwidth}
		...
		grid style = {dashed},
		xmin = 0, xmax = 0.6,
		extra y ticks={0, 10,  5.4},
		extra y tick style={grid style={black, thick, dashed}},
		ytick = {0, 2},
		]
	
		\addplot[blue, mark = none, thick, smooth, solid] table [x = t, y = w3] {data/FullModel/Moment-w.dat};
	...
	\begin{subfigure}{0.5\textwidth}
		...
		grid style = {dashed},
		xmin = 0, xmax = 0.6,
		extra y ticks={0, 5.56, 10},
		extra y tick style={grid style={black, thick, dashed}},
		ytick = {4},
		]
	
		\addplot[blue, mark = none, thick, smooth, solid] table [x = t, y = I3] {data/FullModel/Moment-I.dat};
	...
	\begin{subfigure}{0.5\textwidth}
		...
		\addplot[blue, mark = none, thick, smooth, solid] table [x = t, y = alpha3] {data/FullModel/Moment-alpha.dat};
	...
	\begin{subfigure}{0.5\textwidth}
		...
		\end{tikzpicture}
	\end{subfigure}
	\caption{Графики прехеходных процессов при различных $M_\text{СМ}$ = 6[Нм]}
\end{figure}
...
\begin{figure}[h!]
	\begin{subfigure}{0.5\textwidth}
		...
		grid style = {dashed},
		xmin = 0, xmax = 0.6,
		extra y ticks={0, 2, 3.09},
		extra y tick style={grid style={black, thick, dashed}},
		ytick = {0, 2},
		]
		
		\addplot[blue, mark = none, thick, smooth, solid] table [x = t, y = w4] {data/FullModel/Moment-w.dat};
	...
	\begin{subfigure}{0.5\textwidth}
		...
		grid style = {dashed},
		xmin = 0, xmax = 0.6,
		extra y ticks={0, 5, 8.34, 10},
		extra y tick style={grid style={black, thick, dashed}},
		]
		
		\addplot[blue, mark = none, thick, smooth, solid] table [x = t, y = I4] {data/FullModel/Moment-I.dat};
	...
	\begin{subfigure}{0.5\textwidth}
		...
		\addplot[blue, mark = none, thick, smooth, solid] table [x = t, y = alpha4] {data/FullModel/Moment-alpha.dat};
...
\begin{figure}[h!]
    ...
    \begin{subfigure}{0.5\textwidth}
        ...
        \end{tikzpicture}
    \end{subfigure}
    \caption{Графики прехеходных процессов при  $J_\text{М}$ = 0.025[кг$\text{м}^2$]}
\end{figure}
\newpage
\begin{figure}[h!]
	\begin{subfigure}{0.5\textwidth}
		...
		\addplot[blue, mark = none, thick, smooth, solid] table [x = t, y = w2] {data/FullModel/InertiaMoment-w.dat};
	...
	\begin{subfigure}{0.5\textwidth}
		...
		\addplot[blue, mark = none, thick, smooth, solid] table [x = t, y = I2] {data/FullModel/InertiaMoment-I.dat};
	...
	\begin{subfigure}{0.5\textwidth}
		...
		\addplot[blue, mark = none, thick, smooth, solid] table [x = t, y = alpha2] {data/FullModel/InertiaMoment-alpha.dat};
	...
	\begin{subfigure}{0.5\textwidth}
		...
		\end{tikzpicture}
	\end{subfigure}
	\caption{Графики прехеходных процессов при $J_\text{М}$ = 0.05[кг$\cdot\text{м}^2$]}
\end{figure}
\newpage
\begin{figure}[h!]
	\begin{subfigure}{0.5\textwidth}
		...
		\addplot[blue, mark = none, thick, smooth, solid] table [x = t, y = w3] {data/FullModel/InertiaMoment-w.dat};
	...
	\begin{subfigure}{0.5\textwidth}
		...
		\addplot[blue, mark = none, thick, smooth, solid] table [x = t, y = I3] {data/FullModel/InertiaMoment-I.dat};
	...
	\begin{subfigure}{0.5\textwidth}
		...
		\addplot[blue, mark = none, thick, smooth, solid] table [x = t, y = alpha3] {data/FullModel/InertiaMoment-alpha.dat};
	...
	\begin{subfigure}{0.5\textwidth}
		...
		\end{tikzpicture}
	\end{subfigure}
	\caption{Графики прехеходных процессов при $J_\text{М}$ = 0.075[кг$\cdot\text{м}^2$]}
\end{figure}
\newpage
\begin{figure}[h!]
	\begin{subfigure}{0.5\textwidth}
		...
		\addplot[blue, mark = none, thick, smooth, solid] table [x = t, y = w4] {data/FullModel/InertiaMoment-w.dat};
	...
	\begin{subfigure}{0.5\textwidth}
		...
		\addplot[blue, mark = none, thick, smooth, solid] table [x = t, y = I4] {data/FullModel/InertiaMoment-I.dat};
	...
	\begin{subfigure}{0.5\textwidth}
		...
		\addplot[blue, mark = none, thick, smooth, solid] table [x = t, y = alpha4] {data/FullModel/InertiaMoment-alpha.dat};
	...
	\begin{subfigure}{0.5\textwidth}
		...
		\end{tikzpicture}
	\end{subfigure}
	\caption{Графики прехеходных процессов при  $J_\text{М}$ = 0.1[кг$\cdot\text{м}^2$]}
\end{figure}
\newpage
...
\begin{figure}[h!]
	...
	\begin{subfigure}{0.5\textwidth}
		...
		\end{tikzpicture}
	\end{subfigure}
	\caption{Графики прехеходных процессов при $i_p$ = 15 }
\end{figure}
\newpage
\begin{figure}[h!]
	\begin{subfigure}{0.5\textwidth}
		...
		\addplot[blue, mark = none, thick, smooth, solid] table [x = t, y = w2] {data/FullModel/GearRatio-w.dat};
		\end{axis}
		\end{tikzpicture}
	\end{subfigure}
	\begin{subfigure}{0.5\textwidth}
		...
		\addplot[blue, mark = none, thick, smooth, solid] table [x = t, y = I2] {data/FullModel/GearRatio-I.dat};
		\end{axis}
		\end{tikzpicture}
	\end{subfigure}
	\vspace{0.5cm}
	...
	\begin{subfigure}{0.5\textwidth}
		...
		\addplot[blue, mark = none, thick, smooth, solid] table [x = t, y = alpha2] {data/FullModel/GearRatio-alpha.dat};
		\end{axis}
		\end{tikzpicture}
	\end{subfigure}
	\begin{subfigure}{0.5\textwidth}
		...
		\end{tikzpicture}
	\end{subfigure}
	\caption{Графики прехеходных процессов при $i_p$ = 26.25}
\end{figure}
\newpage
\begin{figure}[h!]
	\begin{subfigure}{0.5\textwidth}
		...
		\addplot[blue, mark = none, thick, smooth, solid] table [x = t, y = w3] {data/FullModel/GearRatio-w.dat};
		\end{axis}
		\end{tikzpicture}
	\end{subfigure}
	\begin{subfigure}{0.5\textwidth}
		...
		\addplot[blue, mark = none, thick, smooth, solid] table [x = t, y = I3] {data/FullModel/GearRatio-I.dat};
		\end{axis}
		\end{tikzpicture}
	\end{subfigure}
	\vspace{0.5cm}
	...
	\begin{subfigure}{0.5\textwidth}
		...
		\addplot[blue, mark = none, thick, smooth, solid] table [x = t, y = alpha3] {data/FullModel/GearRatio-alpha.dat};
		\end{axis}
		\end{tikzpicture}
	\end{subfigure}
	\begin{subfigure}{0.5\textwidth}
		...
		\end{tikzpicture}
	\end{subfigure}
	\caption{Графики прехеходных процессов при $i_p$ = 37.5}
\end{figure}
\newpage
\begin{figure}[h!]
	\begin{subfigure}{0.5\textwidth}
		...
		\addplot[blue, mark = none, thick, smooth, solid] table [x = t, y = w4] {data/FullModel/GearRatio-w.dat};
		\end{axis}
		\end{tikzpicture}
	\end{subfigure}
	\begin{subfigure}{0.5\textwidth}
		...
		\addplot[blue, mark = none, thick, smooth, solid] table [x = t, y = I4] {data/FullModel/GearRatio-I.dat};
		\end{axis}
		\end{tikzpicture}
	\end{subfigure}
	\vspace{0.5cm}
	...
	\begin{subfigure}{0.5\textwidth}
		...
		\addplot[blue, mark = none, thick, smooth, solid] table [x = t, y = alpha4] {data/FullModel/GearRatio-alpha.dat};
		\end{axis}
		\end{tikzpicture}
	\end{subfigure}
	\begin{subfigure}{0.5\textwidth}
		...
		\end{tikzpicture}
	\end{subfigure}
	\caption{Графики прехеходных процессов при $i_p$ = 48.75}
\end{figure}
...
\end{table}
\newpage
Ниже предсавлены графки переходных процессов при различных значениях передаточного отношения и не нулевом моменте нагрузки $M_\text{СМ} = M_\text{Н}i_p/2$, при $i_p = 15$.
...
\begin{figure}[h!]
	\begin{subfigure}{0.5\textwidth}
		...
		\addplot[blue, mark = none, thick, smooth, solid] table [x = t, y = w2] {data/FullModel/GearRatioWithMoment-w.dat};
	...
	\begin{subfigure}{0.5\textwidth}
		...
		\addplot[blue, mark = none, thick, smooth, solid] table [x = t, y = I2] {data/FullModel/GearRatioWithMoment-I.dat};
	...
	\begin{subfigure}{0.5\textwidth}
		...
		\addplot[blue, mark = none, thick, smooth, solid] table [x = t, y = alpha2] {data/FullModel/GearRatioWithMoment-alpha.dat};
...
\begin{figure}[h!]
	\begin{subfigure}{0.5\textwidth}
		...
		\addplot[blue, mark = none, thick, smooth, solid] table [x = t, y = w3] {data/FullModel/GearRatioWithMoment-w.dat};
	...
	\begin{subfigure}{0.5\textwidth}
		...
		\addplot[blue, mark = none, thick, smooth, solid] table [x = t, y = I3] {data/FullModel/GearRatioWithMoment-I.dat};
	...
	\begin{subfigure}{0.5\textwidth}
		...
		\addplot[blue, mark = none, thick, smooth, solid] table [x = t, y = alpha3] {data/FullModel/GearRatioWithMoment-alpha.dat};
...
\begin{figure}[h!]
	\begin{subfigure}{0.5\textwidth}
		...
		\addplot[blue, mark = none, thick, smooth, solid] table [x = t, y = w4] {data/FullModel/GearRatioWithMoment-w.dat};
	...
	\begin{subfigure}{0.5\textwidth}
		...
		\addplot[blue, mark = none, thick, smooth, solid] table [x = t, y = I4] {data/FullModel/GearRatioWithMoment-I.dat};
	...
	\begin{subfigure}{0.5\textwidth}
		...
		\addplot[blue, mark = none, thick, smooth, solid] table [x = t, y = alpha4] {data/FullModel/GearRatioWithMoment-alpha.dat};
