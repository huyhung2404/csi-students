...
\begin{figure}[h!]
	...
	\begin{subfigure}{0.5\textwidth}
		...
		\end{tikzpicture}
	\end{subfigure}
	\caption{Графики прехеходных процессов ПД}
\end{figure}
\newpage
\begin{center}
\section{Исследование влияния момента сопротивленя $M_\text{СМ}$}
\end{center}
\par На рисунке 4 представлены переходные процессы ДПТ при различных значениях нагрузочного момента $M_\text{СМ}$.
